      ...
      <div className={classes.Product__Info}>
        ...
        <p className={classes.Product__Info__Description}>
          <span>
            ...
            stews, curries and snacks. It is very low in calories, but high in
            essential folate, vitamins, minerals, antioxidants and dietary
            fiber. Loaded with antioxidants, red cabbage is also known for its
            anti-ageing properties.
          </span>
          <span>
            Tastes excellent both in raw and cooked forms Versatile ingredient
            can be used in a wide range of recipes Can be used as a flavor
            enhancer in stews and curries Fresh, wholesome vegetable can be used
